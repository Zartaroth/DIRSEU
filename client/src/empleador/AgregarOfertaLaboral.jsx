...
import { useAuth } from '../context/AuthProvider'; // Asegúrate de ajustar la ruta a donde está definido tu AuthContext

const AgregarOfertaLaboral = ({ oferta, onSubmit }) => {
...
export default AgregarOfertaLaboral;
