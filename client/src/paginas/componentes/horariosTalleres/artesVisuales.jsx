...
export default function ArtesVisuales() {
  ...
  const handleWhatsAppRedirect = () => {
    window.open('https://chat.whatsapp.com/D3huJ2966eH2m7GBxX0mwa', '_blank');
  };

  return (
    <div className="max-w-4xl mx-auto p-6 bg-gray-50 rounded-lg shadow-lg">
      <h1 className="text-3xl font-bold text-center text-blue-500 mb-6">GRÁFICA Y ARTES VISUALES</h1>
      ...
      <div className="bg-gradient-to-r from-green-400 to-green-500 text-white p-4 rounded-t-lg shadow-md">
        ...
        <h3 className="text-lg font-medium text-center">TALLER DE GRÁFICA Y ARTES VISUALES</h3>
      </div>
      ...
      <div className="bg-white p-6 border border-gray-200 rounded-b-lg shadow-md">
        <div className="flex flex-col md:flex-row justify-between mb-6 text-gray-700">
          <p className="font-semibold">INSTRUCTOR: Javier Yupanqui Licona</p>
          <p className="font-semibold">Celular: 907 807 755</p>
        </div>
          ...
          <table className="w-full border-collapse rounded-lg overflow-hidden">
            ...
            <tbody>
              <tr className="hover:bg-gray-100 transition duration-200">
                <td className="border px-6 py-3">MARTES Y JUEVES</td>
                <td className="border px-6 py-3">De 15:00 a 19:00 h.</td>
                <td className="border px-6 py-3">PRESENCIAL</td>
              </tr>
              <tr className="hover:bg-gray-100 transition duration-200">
                <td className="border px-6 py-3">SÁBADO</td>
                <td className="border px-6 py-3">De 09:00 a 13:00 h.</td>
                <td className="border px-6 py-3">PRESENCIAL</td>
              </tr>
            </tbody>
          </table>
        ...
        <div className="mt-8 flex flex-col sm:flex-row justify-around gap-4">
          ...
          >
            Ir a INSCRIPCIÓN GRÁFICA Y ARTES VISUALES
          </Button>
          <Button
            variant="contained"
            color="success"
